 ...
 * le_mdc_GetDisconnectionReason() or le_mdc_GetPlatformSpecificDisconnectionCode() (refer to
 * your platform documentation for further details).
 *
 * When the data session connection fails, the failure reason can be known using
 * le_mdc_GetDisconnectionReason(), le_mdc_GetPlatformSpecificDisconnectionCode() or
 * le_mdc_GetPlatformSpecificFailureConnectionReason() (refer to your platform documentation
 * for further details).
 *
 * A sample code can be seen in the following page:
...
typedef enum
{
    ...
    LE_MDC_DATA_BEARER_TECHNOLOGY_LTE = 8,
        ///< LTE

    LE_MDC_DATA_BEARER_TECHNOLOGY_TD_SCDMA = 9,
        ///< TD-SCDMA

    LE_MDC_DATA_BEARER_TECHNOLOGY_CDMA2000_1X = 10,
        ///< CDMA2000 1X

    LE_MDC_DATA_BEARER_TECHNOLOGY_CDMA2000_EVDO = 11,
        ///< CDMA2000 HRPD (1xEV-DO)

    LE_MDC_DATA_BEARER_TECHNOLOGY_CDMA2000_EVDO_REVA = 12,
        ///< CDMA2000 HRPD (1xEV-DO RevA)

    LE_MDC_DATA_BEARER_TECHNOLOGY_CDMA2000_EHRPD = 13
        ///< CDMA2000 EHRPD
}
...
typedef enum
{
    LE_MDC_AUTH_NONE = 0x1,
        ///< no authentication

    LE_MDC_AUTH_PAP = 0x2,
        ///< PAP protocol

    LE_MDC_AUTH_CHAP = 0x4
        ///< CHAP protocol
}
le_mdc_Auth_t;
...
typedef enum
{
    ...
    LE_MDC_DISC_USER_AUTHENTIFICATION_FAILURE = 7,
        ///< cf. 3GPP 24.008 Annex I1
