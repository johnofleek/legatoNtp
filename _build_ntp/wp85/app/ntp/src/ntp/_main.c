...
// Startup code for the executable 'ntp'.
...
LE_SHARED const char* _appComponent_le_data_ServiceInstanceName = "ntp.appComponent.le_data";
LE_SHARED const char* _appComponent_le_mdc_ServiceInstanceName = "ntp.appComponent.le_mdc";
LE_SHARED const char* _appComponent_le_mrc_ServiceInstanceName = "ntp.appComponent.le_mrc";
LE_SHARED const char* _appComponent_le_cfg_ServiceInstanceName = "ntp.appComponent.le_cfg";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t ntp_exe_LogSession;
LE_SHARED le_log_Level_t* ntp_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    ntp_exe_LogSession = log_RegComponent("ntp_exe", &ntp_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_appComponent.so");
